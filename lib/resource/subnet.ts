...
export class Subnet extends Resource{
    ...
    createResources(scope: Construct) {
        for (const resoucesInfo of this.resoucesInfo){
            const subnet = this.createSubnet(scope,resoucesInfo);
            resoucesInfo.assign(subnet);
        }
    }

    private createSubnet(scope: Construct,resourceInfo:ResourceInfo){
